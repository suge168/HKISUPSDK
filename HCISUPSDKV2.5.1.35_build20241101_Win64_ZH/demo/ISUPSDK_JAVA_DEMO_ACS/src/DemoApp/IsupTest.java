...
public class IsupTest {
    ...
    public final static Map<Integer, String> deviceInfoMap = new HashMap<>();
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        //初始化报警服务
        //本demo作为通用演示示例，考虑到事件接收功能的常用性，所以默认开启AMS和SS服务的监听，如果应用只需要下行透传操作设备，不需要设备上报事件，AMS和SS这块代码可以注释。
        ...
        for (boolean exit = false; !exit; ) {
            ...
            switch (str.substring(0, 1)) {
                ...
                case "1": {
                    ...
                    AcsFunctionDemo.dispatch(str, lLoginID);
                    break;
                }
                case "2": {
                    /**
