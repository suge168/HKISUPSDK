...
namespace ISUPDemo.Language
{
    class MultiLanguage
    {
        ...
        public static void SetDefaultLanguage(string lang)
        {
            ...
            DataTable dt = ds.Tables["ISUPDemo"];
        ...
        private static Hashtable ReadXMLText(string frmName, string lang)
        {
            try
            {
                ...
                XmlNode root = doc.DocumentElement;
                //获取XML文件中对应该窗口的内容  
                XmlNodeList nodeList = root.SelectNodes("UserControl[Name='" + frmName + "']/Controls/Controls");
        ...
        public static void LoadLanguage(UserControl form)
        {
            //获取当前默认语言  
            ...
            try
            {
                ...
                foreach (Control control in sonControls)
                {
                    ...
                    {
                        System.Windows.Forms.ListView items = (System.Windows.Forms.ListView)control;
                        System.Windows.Forms.ListView.ColumnHeaderCollection head = items.Columns;
                        
                        ListView.ListViewItemCollection cont = items.Items;

                        GetSetListViewSubControls(head, hashText);
                    }
        ...
        private static void GetSetListViewSubControls(ListView.ColumnHeaderCollection controls, Hashtable hashText)
        {
            try
            {
                foreach (ColumnHeader control in controls)
                {
