...
namespace ISUPDemo
{
    public partial class AudioTalk : UserControl
    {
        ...
        public AudioTalk()
        {
            ...
            groupBoxStreamVoiceTalk.Visible = true;
        }
        ...
        public void CheckInitParam()
        {
            ...
            strInfo = string.Format("Encoded Data");
            m_cmbCBDataType.Items.Add(strInfo);
            strInfo = string.Format("PCM Data");
            m_cmbCBDataType.Items.Add(strInfo);
            this.Refresh();
        }
        ...
        private void checkBoxVoiceTalk_CheckedChanged(object sender, EventArgs e)
        {
            if (checkBoxVoiceTalk.Checked)
            {
                m_struVoiceTalkPara.byVoiceTalk = 0;  //voicetalk
                checkBoxVoiceForward.Enabled = false;
            }
            else 
            {
                checkBoxVoiceForward.Enabled = true;
            }
        }

        private void checkBoxVoiceForward_CheckedChanged(object sender, EventArgs e)
        {           
            if (checkBoxVoiceForward.Checked)
            {
                m_struVoiceTalkPara.byVoiceTalk = 1;  //VoiceForward
                checkBoxVoiceTalk.Enabled = false;
            }
            else
            {
                checkBoxVoiceTalk.Enabled = true;
            }
        }
    }
}
