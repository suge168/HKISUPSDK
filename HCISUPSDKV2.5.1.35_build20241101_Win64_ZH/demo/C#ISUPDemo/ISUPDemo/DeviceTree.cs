    ...
    public partial class DeviceTree : UserControl
    {
        ...
        public void UpdateTreeNode()
        {
            ...
            foreach (TreeNode tnDoorNode in tncDoorNodes)
            {
                ...
                if (GetCurDoorName() != null && GetCurDoorName() != "")
                {
                    tnDoorNode.Text = GetCurDoorName();
                }
        ...
        public string GetCurDoorName()
        {
            if (m_iCurDoorIndex < 0 || m_iCurDeviceIndex > AcsDemoPublic.MAX_DEVICES || m_iCurDeviceIndex < 0)
            {
                return null;
            }

            return g_DeviceTree.g_struDeviceInfo[m_iCurDeviceIndex].sDoorName[m_iCurDoorIndex];
        }
        ...
        private uint GetCurACSDeviceDoorNum()
        {
            ...
            if (pOutXMLBuf != null)
            {
                try
                {
                    ...
                    string pOutXMLTmpBuf = pOutXMLBuf.Substring(0, pOutXMLBuf.LastIndexOf('<'));
                    // wait to determine
                    doc.LoadXml(pOutXMLTmpBuf);
        ...
        private string GetACSDeviceAbility(int lUserID, int iAbilityType, string inParam)
        {
            ...
            try
            {
                ...
                if (dwReturnValue)
                {
                    ...
                    pOutXMLBuf = Marshal.PtrToStringAnsi(m_pOutBuf, lentemp);
                }
        ...
        private int getSelCardReaderDisplayImageIndex(int iDeviceIndex, int doorIndex, int cardIndex)
        {
            ...
            if (iDeviceIndex >= 0 && doorIndex >= 0 && cardIndex >= 0)
            {
                ...
                iImage = g_struDeviceInfo[iDeviceIndex].iDoorStatus[doorIndex + (cardIndex + 1)];
            }
        ...
        private void guardToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Setup/close alarm chan succeed");
        }
